...
def run_batch():
    targets = [
        ...
        },
        {
            ...
            "name": "ผู้สาปแช่ง_Chimera_เกิดใหม่ในโลกเวทย์มนต์",
            "subtitles": {
                1: "ก้าวแรกเมื่อโลกเปลี่ยน",
                2: "เผยวิกฤตของทีม",
                3: "ก้าวเข้าท่วมความรู้สึกใหม่",
                4: "เจ็บป่วยแต่ฝ่าด่าน",
                5: "เผยกลัวในการแข่งขัน",
                6: "พ่ายแพ้แต่ยังไม่ยอมแพ้",
                7: "การพบกับศัตรูเก่า",
                8: "การแข่งขันครั้งใหญ่"
            }
        }
    ]
