...
def export_all_social_packs() -> List[str]:
    ...
    stories = [
        ...
        ("จากน้องสาวสู่พี่ใหญ่: สายใยแห่งความรัก", "c9ba3d70c41e7b9e05e4d1110ec5b94e", 1, "การเปลี่ยนแปลงเริ่มต้น"),
        ("ผู้สาปแช่ง Chimera: เกิดใหม่ในโลกเวทย์มนต์", "454f3980e21e630dc4891fa752796d58", 1, "ก้าวแรกเมื่อโลกเปลี่ยน"),
        ...
        ("ทะลุมิติไปเป็นคุณแม่ลูกแฝดยุค 70 พร้อมซูเปอร์มาร์เก็ตลับ", "627d9707279484797acafaba010fcf69", 1, "เกิดใหม่พร้อมซูเปอร์มาร์เก็ต")
    ]
    results = []
    print("\n=================================================================")
