...
def show_publishing_dashboard():
    ...
    print("   1. สาวอภินิหารหัวใจเหล็ก (8 ตอน - ซีรีส์หลักกำลังปล่อยรายวัน ช่วงเวลาทอง)")
    print("   2. วีรบุรุษสุดขี้เกียจแห่งโลกเวทย์มนต์ (8 ตอน - เผยแพร่ครบจบภาคแรกแล้ว)")
    print("   3. สมาคมประกันภัยลี้ลับ (10 ตอน - เผยแพร่ครบจบภาคแรกแล้ว)")
    print("   4. ทะลุมิติไปเป็นคุณแม่ลูกแฝดยุค 70 พร้อมซูเปอร์มาร์เก็ตลับ (10 ตอน - เผยแพร่ครบแล้ว)")
    print("   5. ยอดนักสืบสปีดรัน (10 ตอน - เผยแพร่ครบแล้ว)")
    print("   6. ร้านค้าเหนือโลก: กระจกเงาคนตาย (20 ตอน - เผยแพร่ครบแล้ว)")
    print("=" * 65 + "\n")
