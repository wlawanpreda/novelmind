...
def generate_standard_release_schedule(days: int = 5):
    ...
    plan = [
        ...
        # Day 4
        [
            {"title": "ยอดนักสืบสปีดรัน", "chapter_num": 9},
            {"title": "สมาคมประกันภัยลี้ลับ", "chapter_num": 4},
            {"title": "เหล่ามือกระบี่ไร้แม่เหล็ก", "chapter_num": 5}
        ],
        # Day 5
        [
            {"title": "ยอดนักสืบสปีดรัน", "chapter_num": 10},
            {"title": "แสงแห่งฤดูใบไม้ผลิในเมืองเทา", "chapter_num": 1},
            {"title": "เหล่ามือกระบี่ไร้แม่เหล็ก", "chapter_num": 6}
        ],
        # Day 6
        [
